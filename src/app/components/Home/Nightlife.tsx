      ...
      >
        <section className="px-10 py-32 flex flex-wrap max-sm:flex-col justify-center items-center max-w-7xl relative m-auto">
          ...
          <div className="w-1/2 max-md:w-full p-12 max-md:p-5 max-sm:p-2 text-center">
            <h2 className="text-7xl max-sm:text-5xl uppercase text-white-cus">
              Nightlife
            </h2>
            <h3 className="text-2xl pt-2 max-sm:text-xl uppercase text-white-cus">
              FRIDAYS & SATURDAYS
            </h3>
            <p className="p-10 max-sm:p-4 text-white-cus font-futura">
            ...
            <div className="flex flex-col gap-12 justify-center items-center">
              <button className="uppercase px-32 py-5 font-semibold font-futura tracking-widest border-2 border-brown bg-brown hover:bg-transparent hover:text-brown text-white">
                See Club info
              </button>
            </div>
          </div>
